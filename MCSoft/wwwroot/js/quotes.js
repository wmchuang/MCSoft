; (function (global, undefined) {
    ...
    tips[101] = '德行的实现是由行为，不是由文字。 —— 夸美纽斯';
    tips[102] = '霸祖孤身取二江，子孙多以百城降。豪华尽出成功后，逸乐安知与祸双？ —— 王安石';
    tips[103] = '阴谋陷害别人的人，自己会首先遭到不幸。 —— 伊索';
    tips[104] = '奢则妄取苟取，志气卑辱；一从俭约，则于人无求，于己无愧，是可以养气也。  —— 罗大经';
    tips[105] = '侈则多欲。君子多欲则念慕富贵，枉道速祸。 —— 司马光';
    tips[106] = '知耻近乎勇。 —— 孔丘';
    tips[107] = '辱，莫大于不知耻。 —— 王通';
    tips[108] = '君子忧道不忧贫。 —— 孔丘';
    var quotes = {
        get: function () {
...
!('quotes' in _global) && (_global.quotes = quotes);
  }());