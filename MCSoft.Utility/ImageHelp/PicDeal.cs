...
namespace MCSoft.Utility
{
    ...
    public class PicDeal
    {
        ...
        /// <returns></returns>
        public static string UploadFile(Stream stream, string name, string site)
        {
            ...
            {
                multipartFormDataContent.Add(new ByteArrayContent(buffer), "formFile", name);
                result = webRequest.PostAsync(site, multipartFormDataContent).Result.Content.ReadAsStringAsync().Result;
            }
